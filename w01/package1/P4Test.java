...
public class P4Test {
  public static void main(String[] args) {
    ...
    Lecturer lecturer3 = new Lecturer("L003", "Carol", "Assoc Professor");
...
/**
 * The test method is very big and it tried to do a lot
 * It's better if we use some testing tool/framework
 */